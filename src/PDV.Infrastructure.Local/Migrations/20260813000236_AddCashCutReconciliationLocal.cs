...
{
    /// <inheritdoc />
    public partial class AddCashCutReconciliationLocal : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CashCutId = table.Column<string>(type: "TEXT", nullable: true),
                    CashRegisterId = table.Column<string>(type: "TEXT", nullable: false),
                    CashierUserId = table.Column<string>(type: "TEXT", maxLength: 450, nullable: false),
                    ReconciledByUserId = table.Column<string>(type: "TEXT", maxLength: 450, nullable: false),
                    ...
                    CashSalesTotal = table.Column<decimal>(type: "TEXT", precision: 18, scale: 2, nullable: false),
                    CardSalesTotal = table.Column<decimal>(type: "TEXT", precision: 18, scale: 2, nullable: false),
                    InflowsTotal = table.Column<decimal>(type: "TEXT", precision: 18, scale: 2, nullable: false),
                    OutflowsTotal = table.Column<decimal>(type: "TEXT", precision: 18, scale: 2, nullable: false),
                    ReturnsTotal = table.Column<decimal>(type: "TEXT", precision: 18, scale: 2, nullable: false),
                    ExpectedCash = table.Column<decimal>(type: "TEXT", precision: 18, scale: 2, nullable: false),
                    ExpectedCardVouchers = table.Column<decimal>(type: "TEXT", precision: 18, scale: 2, nullable: false),
                    DeliveredCash = table.Column<decimal>(type: "TEXT", precision: 18, scale: 2, nullable: false),
                    DeliveredCardVouchers = table.Column<decimal>(type: "TEXT", precision: 18, scale: 2, nullable: false),
                    CashDifference = table.Column<decimal>(type: "TEXT", precision: 18, scale: 2, nullable: false),
                    CardVouchersDifference = table.Column<decimal>(type: "TEXT", precision: 18, scale: 2, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CashCutReconciliation_Denominations_CashCutReconciliations_ReconciliationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InventoryConceptMappings_BranchId_DestinationBranchId_Subtype",
                table: "InventoryConceptMappings",
