...
public record OrderFulfillmentStartedEvent(Guid OrderId, string PickerId) : IDomainEvent;
public record OrderFilledEvent(Guid OrderId, string? PickerId) : IDomainEvent;
public record OrderVerifiedEvent(Guid OrderId, string VerifierId) : IDomainEvent;
...
public record OrderReturnedEvent(Guid OrderId, string Reason) : IDomainEvent;
public record OrderSettledEvent(Guid OrderId, string SettledById) : IDomainEvent;
