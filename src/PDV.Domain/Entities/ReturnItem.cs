...
/// <summary>
/// Ítem devuelto dentro de una Devolución. Espejo de SaleItem.
/// </summary>
public class ReturnItem : BaseEntity
{
    ...
    /// <summary>Snapshot del nombre del producto al momento de la devolución.</summary>
    public string ProductName { get; private set; } = string.Empty;

    /// <summary>Precio unitario al que fue vendido originalmente (copiado del SaleItem).</summary>
    public decimal UnitPrice { get; private set; }

    /// <summary>Cantidad devuelta (decimal para soportar granel).</summary>
    public decimal Quantity { get; private set; }

    public decimal TaxRate { get; private set; }
    public bool IsTaxExempt { get; private set; }

    // Calculados — espejo de SaleItem
    public decimal Subtotal => Quantity * UnitPrice;
    public decimal TotalTax => IsTaxExempt ? 0 : Subtotal * (TaxRate / 100m);
    public decimal TotalAmount => Subtotal + TotalTax;

#pragma warning disable CS8618
    private ReturnItem() { } // Para EF Core
#pragma warning restore CS8618
    ...
    internal void SetReturn(Return ret)
    {
        Return = ret ?? throw new DomainException("La devolución asignada no puede ser nula.");
        ReturnId = ret.Id;
    }
