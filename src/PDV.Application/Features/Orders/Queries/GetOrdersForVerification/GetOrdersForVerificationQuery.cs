...
namespace PDV.Application.Features.Orders.Queries.GetOrdersForVerification;

public record GetOrdersForVerificationQuery : IRequest<List<OrderDetailDto>>
{
    public Guid BranchId { get; set; }
    public string? SearchTerm { get; set; }
}

public class GetOrdersForVerificationQueryHandler : IRequestHandler<GetOrdersForVerificationQuery, List<OrderDetailDto>>
{
    private readonly IApplicationDbContext _context;

    public GetOrdersForVerificationQueryHandler(IApplicationDbContext context)
    {
        _context = context;
    }

    public async Task<List<OrderDetailDto>> Handle(GetOrdersForVerificationQuery request, CancellationToken cancellationToken)
    {
        var query = _context.Orders
            ...
            .Where(o => o.BranchId == request.BranchId &&
                        (o.Status == OrderStatus.Filled || o.Status == OrderStatus.Pending || o.Status == OrderStatus.InFulfillment))
            .AsNoTracking();
        ...
        var orders = await query
            .OrderByDescending(o => o.Status == OrderStatus.Filled)
